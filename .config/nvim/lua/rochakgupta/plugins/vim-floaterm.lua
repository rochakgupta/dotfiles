return {
  ...
  config = function()
    ...
    vim.keymap.set('t', '<M-t>', '<C-\\><C-n>:FloatermHide<CR>', { desc = 'Floaterm: Hide terminal' })
    vim.keymap.set('n', '<M-t>', ':FloatermShow<CR>', { desc = 'Floaterm: Show terminal' })
    vim.keymap.set('t', '<M-]>', '<C-\\><C-n>:FloatermNext<CR>', { desc = 'Floaterm: Next terminal' })
